      ...
      <div className="flex-1 overflow-y-auto p-4">
        {!user ? (
          <div className="text-center py-12">
            <LogIn size={48} className="text-gray-300 mx-auto mb-4" />
            <p className="text-gray-500 text-sm">Faça login para acessar</p>
            <p className="text-gray-400 text-xs mt-1">seus diagramas salvos</p>
          </div>
        ) : (
          <div className="space-y-2">
